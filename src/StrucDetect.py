...
if __name__ == '__main__':
    ...
    parser.add_argument("--img_width",type=int, default=1280, help="width of input images in pixel, default 1280")
    parser.add_argument("--img_height",type=int,default=640,  help="height of input images in pixel, default 640")
    parser.add_argument("--beam_width",type=int,default=8, help="parameter for connecting the detected lines, default 8")
    parser.add_argument("--colu_width",type=int,default=15,help="parameter for connecting the detected lines, default 15")
    parser.add_argument("--disable_detect_diag_line",action="store_true", help="disable detecting diagonal lines, default False")
    parser.add_argument("--deg_gap",type=int, default=6, help="the resolution used to categorize line segments by angle, measured in degrees, default 6")
